...
from manage_gdstk import setup_gds_lib, save_gds_file, create_folder_for_mask, save_ordering_mask, save_single_layer, save_single_layer_inverted
...
def main():
    ...
    # Mask names
    mask_name   = 'KAW_BE_v2_contact_layer'
    # Name of top cell
    cell_name   = 'KAW_BE_v2_contact_layer'
    ...
    save_single_layer('contact_pads', chip_mask, mask_name, cell_name, mask_folder, layer_data)
