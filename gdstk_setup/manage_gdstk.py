...
from vcsel_chip_shapes import create_a_marks_all_layers, create_initial_a_marks_all_layers, create_orientation_arrow, create_TLM_circles, create_TLM_pads, create_label, create_all_labels, create_all_labels_overlap
...
class chip_mask:
    ...
    def create_all_labels_overlap(self, x, y):
        label_polygons = create_all_labels_overlap(x, y, self.layer_data)
